...
{
    [TestFixture]
    public class CalculatorSplitOnFlagDelimiterTests
    {
        ...
        [TestCase(-6,"<>><##>&<\n1&2&3")]
        [TestCase(-6,"<<>>##<$$$><###>\n1$$$2###3")]
        public void GIVEN_StringWithCustomFlagBetweenDelimiters_WHEN_Subtracting_RETURN_NegativeSumOfNumbers(int expected, string input)
        {
            //Arrange
