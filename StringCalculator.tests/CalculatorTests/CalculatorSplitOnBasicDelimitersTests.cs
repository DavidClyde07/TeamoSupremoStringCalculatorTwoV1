...
{
    [TestFixture]
    public class CalculatorSplitOnBasicDelimiterTests
    {
        ...
        [TestCase(-6,"1\n2\n3")]
        [TestCase(-6,"1,2\n3")]
        public void GIVEN_StringOfNumberSeparatedByBasicDelimiters_WHEN_Subtracting_RETURN_NegativeSumOfNumbers(int expected, string input)
        {
            //Arrange
